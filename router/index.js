    ...
    children: [{
      ...
      // asset templates
      {
        ...
        children: [{
            ...
            component: () =>
              import("../views/manage-asset-category/AssetCategoryTemplate.vue"),
            meta: {
              title: 'Erohal - Asset category Templates',
            }
          },
          {
            path: "/inspection-templates/asset-category-template",
            name: "asset-category-template",
            component: () =>
              import("../views/manage-asset-category/CreateAssetTemplate.vue"),
            meta: {
              title: 'Erohal - Create Asset  Category Templates',
            }
          },
          {
            path: "/inspection-templates/create-asset-category",
            name: "create-asset-category",
            component: () =>
              import("../views/manage-asset-category/createAssetCategory"),
            meta: {
              title: 'Erohal - Detail Inspection Templates',
            }
          },
