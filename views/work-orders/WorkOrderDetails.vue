...
export default {
  ...
  methods: {
        ...
        .then((response) => {
          if (response.status === 200) {
            ...
            if (type === "same") {
              ...
              this.perivousFinalTemplate = workOrderInspectionTemplate;
            }
          }
        })
        .catch((error) => {
        ...
        if (value.value === "Select Existing") {
          ...
          if (
            ...
            if (!this.workOrderDetail.workOrder.planning.sameInspection) {
              this.workOrderSummary.finalInspectionTitle = this.perivousFinalTemplate.name;
              this.questionTypeFormFinal = this.setTypeLabel(
                this.perivousFinalTemplate.items
              );
            } else {
              this.questionTypeFormFinal = [];
              this.addInputFieldsFinal();
    ...
    existingFunction(value) {
      ...
      if (value === true) {
        ...
        if (
          ...
          this.workOrderSummary.initialInspectionTitle = this.perivousInitialTemplate.name;
          if (this.workOrderDetail.workOrder.planning.sameInspection) {
            this.workOrderSummary.finalInspectionTitle = this.workOrderSummary.initialInspectionTitle;
          }
          this.questionTypeFormInitial = this.setTypeLabel(
    ...
    onIssueNumberSelect(value) {
      ...
      if (value.length > 0) {
        this.workOrderDetail.workOrder.issues = value.filter(v => v.id !== null && v.id !== undefined)
      } else {
    ...
    updateWorkOrder() {
      ...
      if (this.questionTypeFormFinal.length > 0) {
        finalInspectionTemplate = {
          ...
          uuid:
            this.perivousFinalTemplate.uuid !== null &&
            this.perivousFinalTemplate.uuid !== undefined
              ? this.perivousFinalTemplate.uuid
              : null,
        };
      ...
      if (this.workOrderDetail.workOrder.planning.fromInspectionInitial) {
        if (this.selectedInitialInspectionByAsset !== null) {
          this.workOrderDetail.workOrder.planning.initialInspectionUUID = this.selectedInitialInspectionByAsset.value;
        } else if (this.selectedInitialInspectionByAssetCategory !== null) {
          this.workOrderDetail.workOrder.planning.initialInspectionUUID = this.selectedInitialInspectionByAssetCategory.value;
        } else {
          this.workOrderDetail.workOrder.planning.initialInspectionUUID = this.selectedFinalInspectionByWorkOrder.value;
        }
      }

      if (this.workOrderDetail.workOrder.planning.fromInspectionFinal) {
        if (this.sameAsInitialInspection) {
          this.workOrderDetail.workOrder.planning.finalInspectionUUID = this.workOrderDetail.workOrder.planning.initialInspectionUUID;
        } else {
          if (this.selectedFinalInspectionByAsset !== null) {
            this.workOrderDetail.workOrder.planning.finalInspectionUUID = this.selectedFinalInspectionByAsset.value;
          } else if (this.selectedFinalInspectionByAssetCategory !== null) {
            this.workOrderDetail.workOrder.planning.finalInspectionUUID = this.selectedFinalInspectionByAssetCategory.value;
          } else {
            this.workOrderDetail.workOrder.planning.finalInspectionUUID = this.selectedFinalInspectionByWorkOrder.value;
          }
        }
      }
      ...
      if (this.checkExistingInitialInspection) {
        ...
        this.workOrderDetail.workOrder.planning.initialInspectionUUID = this.initialInspectionTemp.uuid;
      } else {
      ...
      if (this.finalInspectionSelection === "Select Existing") {
        ...
        this.workOrderDetail.workOrder.planning.fromInspectionInitial = false;
        this.workOrderDetail.workOrder.planning.finalInspectionUUID = this.selectedFinalInspectionByAssetCategory.uuid;
      } else {
      ...
      if (
        ...
        this.workOrderDetail.workOrder.planning.finalInspectionUUID = this.initialInspectionTemp.uuid;
        this.workOrderDetail.workOrder.planning.fromExistingFinal = true;
      }
      ...
      if (this.checkExistingInitialInspection === true) {
        ...
        updateWorkOrderReq.initialInspectionTemplate = initialInspectionTemplate;
      ...
      if (this.finalInspectionSelection === "Create New Inspection Template") {
        ...
        this.workOrderDetail.workOrder.planning.fromExistingFinal = this.workOrderDetail.workOrder.planning.fromExistingInitial;
        this.workOrderDetail.workOrder.planning.fromInspectionFinal = this.workOrderDetail.workOrder.planning.fromInspectionInitial;
      ...
      updateWorkOrderReq.initialInspectionTemplateLinkingUUID = initialInspectionTemplateLinkingUUID;
      updateWorkOrderReq.finalInspectionTemplateLinkingUUID = finalInspectionTemplateLinkingUUID;
